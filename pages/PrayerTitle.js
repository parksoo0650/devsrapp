                ...
                <section className="pb-10">
                    <main className="px-5 bg-[#F5F5F5]">
                        ...
                        <ol className="pb-10 list-decimal">
                            ...
                            <li className={STYLE_LIST_ITEM_SPECIAL}>
                                3. 사무처리회 성공을 통하여 분열사태가 속히 종식되고 교회가 안전하게 회복되도록
                            </li>
                            <li className={STYLE_LIST_ITEM_SPECIAL}>
                                4. 사무처리회 성공을 통하여 교회의 재정적인 어려움이 해결되도록
                            </li>
                            <li className={STYLE_LIST_ITEM_SPECIAL}>
                                5. 사무처리회 개최일에 성락인 모두 교회를 사랑하는 마음으로 참여하도록
                            </li>
                            <li className={STYLE_LIST_ITEM_SPECIAL}>
                                6. 사무처리회 준비팀, 명부팀. 진행팀에게 지혜와 안목이 넘치도록
                            </li>
                            <li className={STYLE_LIST_ITEM_SPECIAL}>
                                7. 사무처리회 준비가운데 하나님의 사랑과 은혜로 하나 된 지체임을 깨닫고 겸손히 연합할 수 있도록
                            </li>
                            <li className={STYLE_LIST_ITEM_SPECIAL}>
                                8. 사무처리회를 위해 사랑과 겸손의 마음으로 간절히 기도하여 하나님의 일하심을 보도록
                            </li>
                            <li className={STYLE_LIST_ITEM_SPECIAL}>
                                9. 사무처리회를 통해 온 성도가 몸 된 교회를 사랑하고 든든히 세워가도록
                            </li>
                            <li className={STYLE_LIST_ITEM_SPECIAL}>
                                10. 사무처리회 성공을 위한 목장 및 목양사역이 될 수 있도록
                            </li>
                            <li className={STYLE_LIST_ITEM_SPECIAL}>
                                11. 사무처리회 성공을 위해 각 가정과 직장 거처에서 기도로 동참하도록
                            </li>
                            <li className={STYLE_LIST_ITEM_SPECIAL}>
                                12. 사무처리회 현장 참석이 불가능한 성도들은 위임장을 반드시 작성하여 제출 하도록
                            </li>
                            <li className={STYLE_LIST_ITEM_SPECIAL}>
                                13. 분열측 성도들이 거짓이 아닌 진실 앞에 결단하여 사무처리회에 참석 하도록
                            </li>
                            <li className={STYLE_LIST_ITEM_SPECIAL}>
                                14. 장로, 안수집사 및 직분자들이 준비 과정에서 적극적으로 교회와 함께 하도록
                            </li>
                            <li className={STYLE_LIST_ITEM_SPECIAL}>
                            ...
                            <li className={STYLE_LIST_ITEM_SPECIAL}>
                                17. 사무처리회 현장 참여를 위해 성도들을 찾아가 적극 독려할 수 있도록
                            </li>
                            <li className={STYLE_LIST_ITEM_SPECIAL}>
                                18. 사무처리회 당일 참여치 못할 갑작스러운 다른 일정이 생기지 않도록
                            </li>
                            <li className={STYLE_LIST_ITEM_SPECIAL}>
                            ...
                            <li className={STYLE_LIST_ITEM_SPECIAL}>
                                24. 성락인 모두 하나 되어 교회와 감독님의 든든한 조력자로 협력하도록
                            </li>
                            <li className={STYLE_LIST_ITEM_SPECIAL}>
                                25. 성락인과 베뢰아인과 미래세대를 감독님께서 온전히 이끌어가시도록
                            </li>
                        </ol>
                    </main>
                    ...
                    {/*        </li>*/}
                    {/*        <li className={STYLE_LIST_ITEM}>*/}
                    {/*            6. 높아진 마음을 버리고 사랑과 겸손의 마음을 갖도록*/}
                    {/*        </li>*/}
                    {/*        <li className={STYLE_LIST_ITEM}>*/}
                    {/*            7. 하나님의 사랑과 은혜로 하나된 지체임을 깨닫고 겸손히 연합할 수 있도록*/}
                    {/*        </li>*/}
                    {/*        <li className={STYLE_LIST_ITEM}>*/}
                    {/*            8. 하나님과 교회 앞에 사랑과 겸손으로 충성과 헌신을 다하고 신실한 일군이 되도록*/}
                    {/*        </li>*/}
                    {/*        <li className={STYLE_LIST_ITEM}>*/}
                    {/*            9. 사무처리회를 위해 사랑과 겸손의 마음으로 간절히 기도하여 하나님의 일하심을 보도록*/}
                    {/*        </li>*/}
                    {/*        <li className={STYLE_LIST_ITEM}>*/}
                    {/*            10. 사무처리회를 통해 온 성도가 몸 된 교회를 사랑하고 든든히 세워가도록*/}
                    {/*        </li>*/}
                    {/*    </ol>*/}
                    {/*</div>*/}
                    {/*<div className="pt-[30px] px-5">*/}
                    ...
                    {/*        </li>*/}
                    {/*        <li className={STYLE_LIST_ITEM}>*/}
                    {/*            6. 장로, 안수집사 및 직분자들이 준비 과정에서 적극적으로 교회와 함께하도록*/}
                    {/*        </li>*/}
                    {/*        <li className={STYLE_LIST_ITEM}>*/}
                    {/*            7. 노약자나 환우도 사랑으로 섬겨 사무처리회 현장에 함께할 수 있도록*/}
                    {/*        </li>*/}
                    {/*        <li className={STYLE_LIST_ITEM}>*/}
                    {/*            8. 모든 성도가 교회를 사랑하는 마음으로 사무처리회에 적극 참여하도록*/}
                    {/*        </li>*/}
                    {/*        <li className={STYLE_LIST_ITEM}>*/}
                    {/*            9. 모든 목장이 사무처리회 성공을 위한 사역으로 적극 지원하도록*/}
                    {/*        </li>*/}
                    {/*        <li className={STYLE_LIST_ITEM}>*/}
                    {/*            10. 사무처리회에 참여함으로 교인으로서의 책임과 의무를 다하도록*/}
                    {/*        </li>*/}
                    {/*    </ol>*/}
                    {/*</div>*/}
                    {/*<div className="pt-[30px] px-5">*/}
