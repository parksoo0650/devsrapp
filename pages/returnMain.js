    ...
    <>
      <div className='sub_container'>
        ...
        {isLoading === true ? (
          ...
          <>
            <Card.Rounded
              route={`/returnDetail?vid=${mainData.videoId}&vtit=${mainData.title}&vdate=${mainData.publishedAt}`}
              data={mainData}
              thumbnails='/images/kakao_tue.jpg'
              preacher='김기동 원로감독'
            />
                ...
                {listData.map((doc, i) => {
                  ...
                  return (
                    <li
                      ...
                      onClick={() => {
                        router.push(
                          `/returnDetail?vid=${doc.snippet.resourceId.videoId}&vtit=${ListTitle}&vdate=${lDate}`,
                          '/sermondetail'
                        );
                      }}
                    >
